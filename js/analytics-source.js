(function () {
    ...
    var pa = function () {
        ...
        this.M = function () {
            for (var b = [], c = 0; c < a.length; c++)
                a[c] && (b[Math.floor(c / 6)] = b[Math.floor(c / 6)] ^ 1 << c % 6);
    ...
    Ha.prototype.D = function (a) {
        ...
        b = a.get(Ia);
        b != L && isFunction(b) && (a.set(Ia, L, true), setTimeout(b, 10))
    };
    function Ja(a) {
    ...
    function fc() {
        ...
        if (!b) try {
            ...
            (a = b.match(/[\d]+/g)) && 3 <= a.length && (b = a[0] + "." + a[1] + " r" + a[2]); return b || undefined
    };
    var gc = function (a, b) {
        var c = Math.min(getAttrInteger(a, dc), 100);
        if (!(La(getAttrString(a, Q)) % 100 >= c) && (c = {}, Ec(c) || Fc(c))) {
            var d = c[Eb]; undefined == d || Infinity == d || isNaN(d) || (0 < d ? (Y(c, Gb), Y(c, Jb), Y(c, Ib), Y(c, Fb), Y(c, Hb), Y(c, Kb), Y(c, Lb), b(c)) : ta(window, "load", function () {
                gc(a, b)
            }, false))
        }
    }, Ec = function (a) {
        var b = window.performance || window.webkitPerformance, b = b && b.timing; if (!b) return false;
    ...
    var Dc = function (a) {
        this.target = a; this.T = false
    };
    Dc.prototype.Q = function (a, b) {
        if (a.tagName) {
            if ("a" == a.tagName.toLowerCase()) {
                a.href && setLink(a, qd(this, a.href, b));
                return
            }
    ...
    Dc.prototype.S = function (a, b, c) {
        ...
        var e = this; this.T || (this.T = true, ta(document, "mousedown", d, false), ta(document, "touchstart", d, false), ta(document, "keyup", d, false));
        if (c) {
            c = function (c) {
                c = c || window.event;
    ...
    var gd = function (a) {
        ...
        hd = function (a) {
            if (a.get(ed)) {
                ...
                c(Q);
                c(ed);
                var d = getAttrInteger(a, "forceSSL") || "https:" == document.location.protocol ? "https:" : "http:", d = d + "//" + __serverHost + "/log/collect.php?t=dc&aip=1&";
                b.map(function (a, c) {
                    d += sa(a) + "=" + sa("" + c) + "&"
                });
                d += "z=" + randomInteger();
    ...
    function $c() {
        if (!(1 <= randomInteger() % 1E4) && (J(33), window.top != window)) {
            J(34);
            try {
                undefined != window.top.location.href && J(35)
            } catch (a) {
    ...
    var Lc = function (a) {
        a.I || (a.I = true, gc(a.b, function (b) {
            a.send("timing", b)
        }))
    };
    var rc = function (a) {
        ...
        Mc = function (a) {
            if (!rc(a)) {
                ...
                var b = false, c = function () {
                    !b && rc(a) && (b = true, ua(document, "webkitvisibilitychange", c))
                };
                        ...
                        if (!isFunction(Z.k.get(d.a[0])) && !d.H && e) {
                            ...
                            if (s = l) {
                                ...
                                if (g.G || 0 <= g.url.indexOf("?") || 0 <= g.path.indexOf("://"))
                                    ...
                                    s = __serverHost ==
                                        g.host && (g.port || vb) == vb && 0 == g.path.indexOf("/plugins/") ? true : false
                                }
                            }
                            s && (d.H = !!createScriptNode(ca.url))
                        }
                    }
                    b.push(d)
                }
            ...
            if (a.u)
                ...
                if (a.A)
                    ...
                    if (a.i)
                        ...
                        a.e && (b = b.plugins_.get(a.e)), b[a.d].apply(b, a.a)
            }
        } catch (c) {
    ...
    function La(a) {
        ...
        if (a)
            for (b = 0, d = a.length - 1; 0 <= d; d--)
                c = a.charCodeAt(d),
                    b = (b << 6 & 268435455) + c + (c << 14), c = b & 266338304, b = 0 != c ? b ^ c >> 21 : b;
        return b
    };
})(window);